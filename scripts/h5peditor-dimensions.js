...
ns.Dimensions.prototype.createHtml = function () {
  var input = ns.createText('Width', this.params !== undefined ? this.params.width : undefined, 15) + ' x ' + ns.createText('Height', this.params !== undefined ? this.params.height : undefined, 15);
