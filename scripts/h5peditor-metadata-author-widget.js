...
H5PEditor.metadataAuthorWidget = function (semantics, params, $wrapper, parent) {
    ...
    params.authors.forEach(function (author) {
      ...
      $('<button>', {
        ...
        click: function () {
          ...
          }, handleRemoveActionForMetadataAuthor, author);
        }
      }).appendTo(listItem);
   ...
   * @param {object} [auhor] Author to be removed
   */
  function handleRemoveActionForMetadataAuthor(confirmFlag, author) {
    if (confirmFlag) {
      removeAuthor(author);
    }
  }
