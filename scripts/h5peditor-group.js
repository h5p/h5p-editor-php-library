...
ns.Group.prototype.appendTo = function ($wrapper) {
  ...
  this.$group = ns.$('<fieldset class="field group"><div class="title"><a href="#" class="expand" title="' + ns.t('core', 'expandCollapse') + '"></a><span class="text"></span></div><div class="h5p-editor-content"></div></fieldset>')
  ...
  if (this.field.fields.length === 1) {
    ...
    this.children[0].appendTo(this.$group.children('.h5p-editor-content'));
  }
  else {
    ...
    ns.processSemanticsChunk(this.field.fields, this.params, this.$group.children('.h5p-editor-content'), this);
  }
