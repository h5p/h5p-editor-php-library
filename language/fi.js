H5PEditor.language.core = {
  ...
  listExceedsMax: 'Listan pituus ylittää enimmäismäärän :max.',
  ...
  or: 'tai',
  enterAudioUrl: 'Anna äänen lähdeosoite URL',
  enterVideoUrl: 'Anna videon lähdeosoite URL tai YouTube linkki',
  enterAudioTitle: 'Liitä linkki tai muu äänen lähdeosoite URL',
  enterVideoTitle: 'Liitä YouTube linkki tai muu videon lähdeosoite URL',
  ...
  uploadInstructionsContent: 'Voit aloittaa esimerkeistä <a href="https://h5p.org/content-types-and-applications" target="blank">H5P.org</a>.',
  ...
  ' lisätietoja varten.',
  contentTypeSectionAll: 'Kaikki',
  contentTypeSectionMine: 'Sisältötyyppini',
  contentTypeSectionPopular: 'Suosituimmat',
  contentTypeSectionTitle: 'Selaa sisältötyyppejä',
  ...
  contentTypeUseButtonLabel: 'Käytä',
