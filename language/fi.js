H5PEditor.language.core = {
  ...
  pasteContentNotSupported: 'Sisältö jota yrität liittää ei ole tuettu tässä kontekstissa.',
  pasteTooOld: 'Sisältötyyppi jota yrität liittää on tehty varhaisemmalla H5P:n sisältötyypiversiolla (:clip) kuin kontekstin versio (:local) johon yrität sitä nyt yrität liittää. Jos mahdollista pyydä alkuperäinen aineisto uudemmalla sisältötyyppiversiolla ennen kuin yrität sen liittämistä tänne.',
  pasteTooNew: 'Sisältötyyppi jota yrität liittää on tehty H5P:n uudemmalla sisältötyyppiversiolla (:clip) kuin mitä tämä konteksti (:local) tukee. Olet hyvä ja pyydä että ylläpitäjät päivittävät sisältötyyppinne ajantasalle.',
  ok: 'OK',
