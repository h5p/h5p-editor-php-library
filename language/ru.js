H5PEditor.language.core = {
  ...
  pasteContentNotSupported: 'Содержимое, которое вы пытаетесь вставить, не поддерживается в этом контексте.',
  pasteTooOld: 'Содержимое, которое вы пытаетесь вставить, имеет более низкую версию (:clip) чем то, что поддерживаемая в этом контексте (:local), если возможно, попробуйте обновить содержимое, которое вы хотите вставить, скопируйте его снова и попробуйте вставить его сюда.',
  pasteTooNew: 'Содержимое, которое вы пытаетесь вставить, имеет более высокую версию (:clip) чем то, что поддерживаемая в этом контексте (:local), если возможно, попробуйте сначала обновить этот контент, а затем снова попробуйте вставить его здесь.',
  ok: 'ОК',
