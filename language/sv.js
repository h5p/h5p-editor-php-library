H5PEditor.language.core = {
  ...
  enterVideoUrl: 'Ange URL för videokälla eller YouTube-länk',
  ...
  addVideoDescription: 'H5P stödjer alla externa videokällor som är formaterade som mp4, webm eller ogv, såsom Vimeo Pro, och stödjer YouTube-länkar.',
  insert: 'Infoga',
  cancel: 'Avbryt',
  height: 'höjd',
  width: 'bredd',
