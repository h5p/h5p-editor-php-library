H5PEditor.language.core = {
  ...
  dragAndDropAndPasteImage: 'Arrastra y suelta la imagen aquí para subirla o pégala usando :keyCombination',
  ...
  uploadingImage: 'Subiendo la imagen, por favor, espera.',
  replaceImage: '¿Reemplazar imagen?',
  confirmReplaceImage: '¿Estás seguro de que deseas reemplazar esta imagen?',
  onlyPasteImageFiles: 'Solo puedes pegar archivos de imagen.',
  uploadVideo: 'Subir Video',
  uploadAudio: 'Subir Audio',
  uploadOr: 'o',
  dragAndDropAndPasteVideo: 'Arrastra o pega el video aquí para subirlo o pégalo usando :keyCombination',
  dragAndDropAndPasteAudio: 'Arrastra o pega el audio aquí para subirlo o pégalo usando :keyCombination',
  ...
  dropAudio: 'Arrastra el audio aquí para subirlo',
  enterVideoLink: 'Inserta el enlace del video',
  enterAudioLink: 'Inserta el enlace del audio',
  insertUrl: 'Insertar enlace',
  replaceUrl: 'Reemplazar enlace',
  ctrlKey: 'ctrl',
  commandKey: '⌘',
  pasteKey: 'v',
  supportedVideoFormats: 'H5P soporta las siguientes fuentes de vídeo: <span class="h5p-bold">Youtube</span>, <span class="h5p-bold">Panopto</span>, <span class="h5p-bold">Vimeo</span> y <span class="h5p-bold">Echo360</span>.',
