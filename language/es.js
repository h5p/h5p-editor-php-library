H5PEditor.language.core = {
  ...
  pasteTooNew: 'El contenido que está intentando pegar es de una versión superior (:clip) de lo que se soporta en este contexto (:local), si es posible, trate de actualizar este contenido primero, y luego intente pegar el contenido aquí de nuevo.',
  ok: 'OK',
