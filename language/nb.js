H5PEditor.language.core = {
  ...
  fileTooBig: 'Filen du prøver å laste opp er for stor. Grensen er :sizeLimit.',
  ...
  saveLabel: 'Lagre',
  cancelLabel: 'Avbryt',
  deleteAudioLabel: 'Fjern Lydfil',
  deleteVideoLabel: 'Fjern Videofil',
  ...
  unsupportedVideoSource: "Videokilden er ikke støttet",
  unsupportedAudioSource: "Lydkilden er ikke støttet",
  insert: 'Sett inn',
  cancel: 'Avbryt',
  height: 'Høyde',
  width: 'Bredde',
  ...
  videoQualityPlaceholder: '1080p, 720p, HD, Mobil, etc',
