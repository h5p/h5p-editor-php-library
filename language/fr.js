H5PEditor.language.core = {
  ...
  dragAndDropAndPasteImage: 'Glisser-déposer ou coller un fichier image ici via :keyCombination pour l’ajouter',
  ...
  uploadOr: 'ou',
  dragAndDropAndPasteVideo: 'Glisser-déposer ou coller un fichier vidéo ici via :keyCombination pour l’ajouter',
  dragAndDropAndPasteAudio: 'Glisser-déposer ou coller un fichier audio ici via :keyCombination pour l’ajouter',
  ...
  commandKey: '⌘',
  pasteKey: 'v',
  supportedVideoFormats: 'H5P supporte les sources vidéo externes suivantes&nbsp;: <span class="h5p-bold">Youtube</span>, <span class="h5p-bold">Panopto</span>, <span class="h5p-bold">Vimeo</span> et <span class="h5p-bold">Echo360</span>.',
