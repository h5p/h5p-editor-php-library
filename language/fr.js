H5PEditor.language.core = {
  ...
  confirmImageRemoval: 'Voulez-vous vraiment supprimer cette image ?',
  dragAndDropAndPasteImage: 'Glisser-déposer ou coller un fichier image ici via <span class="h5p-dnd__badge">ctrl<span class="h5p-dnd__badge__separator"></span>⌘</span> + <span class="h5p-dnd__badge">v</span> pour l’ajouter',
  dragAndDropAndPasteReplaceImage: 'Glisser-déposer ou coller un fichier image ici pour remplacer',
  dropImage: 'Déposer un fichier image ici pour l\'ajouter',
  uploadImage: 'Ajouter une image',
  uploadingImage: 'Ajout de l\'image, veuillez patienter.',
  replaceImage: 'Remplacer l\'image ?',
  confirmReplaceImage: 'Voulez-vous vraiment remplacer cette image ?',
  onlyPasteImageFiles: 'Vous ne pouvez coller que des fichiers image.',
  uploadVideo: 'Ajouter une vidéo',
  uploadAudio: 'Ajouter un fichier audio',
  uploadOr: 'ou',
  dragAndDropAndPasteVideo: 'Glisser-déposer ou coller un fichier vidéo ici via <span class="h5p-dnd__badge">ctrl<span class="h5p-dnd__badge__separator"></span>⌘</span> + <span class="h5p-dnd__badge">v</span> pour l’ajouter',
  dragAndDropAndPasteAudio: 'Glisser-déposer ou coller un fichier audio ici via <span class="h5p-dnd__badge">ctrl<span class="h5p-dnd__badge__separator"></span>⌘</span> + <span class="h5p-dnd__badge">v</span> pour l’ajouter',
  ...
  dropAudio: 'Déposer un fichier audio ici pour l\'ajouter',
  enterVideoLink: 'Entrer un lien vidéo',
  enterAudioLink: 'Entrer un lien audio',
  ...
  errorCalculatingMaxScore:
    'Impossible de calculer le score maximal pour ce contenu. La note maximale est supposée être 0. Contactez votre administrateur si cela n’est pas correct.',
