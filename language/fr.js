H5PEditor.language.core = {
  ...
  h5pFileValidationFailedContent: 'Merci de vérifier que le fichier H5P téléversé contient un contenu H5P valide.' +
  'Les fichiers contenant uniquement des librairies doivent être téléversés en utilisant la page des Librairies H5P.',
  h5pFileUploadServerErrorTitle: 'Le fichier H5P n\'a pas pu être téléversé.',
  h5pFileUploadServerErrorContent: 'Une erreur inattendue s\'est produite. Vérifier le journal des erreurs de votre serveur ' +
