H5PEditor.language.core = {
  ...
  pasteContentNotSupported: 'Sisu, mida püüad kleepida, ei ole siin ümbruses lubatud',
  pasteTooOld: 'Sisu, mida püüad kleepida (:clip), on siin sisu toetatavast (:local) madalamas versioonis. Võimaluse korral püüa sisu uuendada, uuesti mällu kopeerida ja siis siia kleepida.',
  pasteTooNew: 'Sisu, mida püüad kleepida (:clip), on siin toetatavast (:local) kõrgemas versioonis. Võimaluse püüa sisu uuendada, uuesti mällu kopeerida ja siis siia kleepida.',
  ok: 'Hästi',
