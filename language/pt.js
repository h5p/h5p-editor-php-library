H5PEditor.language.core = {
  ...
  enterVideoUrl: 'Insira o URL do vídeo ou uma hiperligação do YouTube',
  ...
  addVideoDescription: 'H5P suporta todos as fontes externas de vídeo no formato mp4, webm ou ogv, como Vimeo Pro, e fornece suporte para hiperligações do YouTube.',
  insert: 'Inserir',
  cancel: 'Cancelar',
  height: 'altura',
  width: 'largura',
